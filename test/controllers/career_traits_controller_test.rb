...
class CareerTraitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career_trait" do
    assert_difference("CareerTrait.count") do
      post career_traits_url, params: { career_trait: { career_id: @career_trait.career_id, personality_trait_id: @career_trait.personality_trait_id } }
    end
  ...
  test "should update career_trait" do
    patch career_trait_url(@career_trait), params: { career_trait: { career_id: @career_trait.career_id, personality_trait_id: @career_trait.personality_trait_id } }
