...
class TraitWeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create trait_weight' do
    assert_difference('TraitWeight.count') do
      post trait_weights_url,
           params: {
             trait_weight: {
               Trait1_weight: @trait_weight.Trait1_weight,
               Trait2_weight: @trait_weight.Trait2_weight,
               Trait3_weight: @trait_weight.Trait3_weight,
               Trait4_weight: @trait_weight.Trait4_weight,
               Trait5_weight: @trait_weight.Trait5_weight,
               Trait6_weight: @trait_weight.Trait6_weight,
               career_id: @trait_weight.career_id
             }
           }
    end
  ...
  test 'should update trait_weight' do
    patch trait_weight_url(@trait_weight),
          params: { trait_weight:
            { Trait1_weight: @trait_weight.Trait1_weight,
              Trait2_weight: @trait_weight.Trait2_weight,
              Trait3_weight: @trait_weight.Trait3_weight,
