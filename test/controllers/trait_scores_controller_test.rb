...
class TraitScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trait_score" do
    assert_difference("TraitScore.count") do
      post trait_scores_url, params: { trait_score: { personality_trait_id: @trait_score.personality_trait_id, score: @trait_score.score, user_id: @trait_score.user_id } }
    end
  ...
  test "should update trait_score" do
    patch trait_score_url(@trait_score), params: { trait_score: { personality_trait_id: @trait_score.personality_trait_id, score: @trait_score.score, user_id: @trait_score.user_id } }
